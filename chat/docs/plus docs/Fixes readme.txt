...
Client browsers - tested with:
	...
	- Mozilla Firefox > 1.6.0.0 (up to and including 50.00) = H;
	...
	- Google Chrome > 55.x.x.x.x = H;
	- Microsoft Edge;
	- Tor Browser < 6.0.8 = H.
Server environment - tested env:
	- Apache < 2.4.25 (Unix and Windows 2k/XP/Vista/7/8/8.1/10);
	- ISS < 7;
	- php < 7.1.3;
	- MySQL < 5.7.17; (mysqli extension recommended, but mysql extension is still available for some old versions)
	- MariaDB 5.5.4 & 10.1.22;
...
Note: development has been carried out on WampServer 3.0.8 64b, running on Windows 10 Pro Insider Preview 64b;
